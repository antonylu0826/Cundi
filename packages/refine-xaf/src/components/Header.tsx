...
import { Layout, Button, Space, Typography, Avatar, theme, Dropdown, MenuProps, Modal, Form, Input, message } from "antd/lib";
...
export const Header: React.FC = () => {
    ...
    const handlePhotoSubmit = async (values: { Photo: string }) => {
        ...
        try {
            ...
            // httpClient returns response object or null (204)
