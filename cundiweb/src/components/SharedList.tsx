...
interface SharedListProps<T = BaseRecord> {
    children?: React.ReactNode;
    resource?: string;
    searchFields?: string[];
}

export const SharedList = <T extends BaseRecord = BaseRecord>({
    children,
    resource,
    searchFields,
}: SharedListProps<T>) => {
                ...
                <Form {...searchFormProps} layout="inline">
                    <Form.Item name="search">
                        <Input.Search
                            ...
                            onSearch={(value) => {
                                if (!value) {
                                    // Hard reset to ensure clean state and data reload
                                    // This resolves the persistent "No Data" issue by forcing a fresh page load
